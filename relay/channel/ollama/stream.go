...
func ollamaStreamHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.NewAPIError) {
	...
	for scanner.Scan() {
		...
		if !chunk.Done {
			...
			// The synthetic start frame above is generated by new-api itself and must
			// not be treated as TTFT. Record FRT only when Ollama emits the first
			// meaningful content/reasoning/tool-call chunk.
			if hasRealOutput {

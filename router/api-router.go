	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/waffo-pancake/pay", middleware.CriticalRateLimit(), controller.SubscriptionRequestWaffoPancakePay)
		...
		logRoute.GET("/rate_limit_dashboard", middleware.AdminAuth(), controller.GetRateLimitDashboard)
		...
		tokenDailyRoute := apiRouter.Group("/token-daily")
		tokenDailyRoute.GET("/model", middleware.AdminAuth(), controller.GetAllTokenDailyModel)
		tokenDailyRoute.GET("/total", middleware.AdminAuth(), controller.GetAllTokenDailyTotal)
		tokenDailyRoute.GET("/model/self", middleware.UserAuth(), controller.GetUserTokenDailyModel)
		tokenDailyRoute.GET("/total/self", middleware.UserAuth(), controller.GetUserTokenDailyTotal)

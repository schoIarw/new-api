...
import { Route as AuthenticatedTokenDailyIndexRouteImport } from './routes/_authenticated/token-daily/index'
...
const AuthenticatedTokenDailyIndexRoute =
  AuthenticatedTokenDailyIndexRouteImport.update({
    id: '/token-daily/',
    path: '/token-daily/',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any)
...
export interface FileRoutesByFullPath {
  ...
  '/token-daily/': typeof AuthenticatedTokenDailyIndexRoute
...
export interface FileRoutesById {
  ...
  '/_authenticated/token-daily/': typeof AuthenticatedTokenDailyIndexRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/token-daily/': {
      id: '/_authenticated/token-daily/'
      path: '/token-daily'
      fullPath: '/token-daily/'
      preLoaderRoute: typeof AuthenticatedTokenDailyIndexRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
    '/_authenticated/system-settings/': {
      id: '/_authenticated/system-settings/'
...
interface AuthenticatedRouteRouteChildren {
  ...
  AuthenticatedTokenDailyIndexRoute: typeof AuthenticatedTokenDailyIndexRoute
...
const AuthenticatedRouteRouteChildren: AuthenticatedRouteRouteChildren = {
  ...
  AuthenticatedTokenDailyIndexRoute: AuthenticatedTokenDailyIndexRoute,
